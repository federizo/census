        ...
        <div className="grid gap-3 w-full">
            ...
            <div className="flex items-center gap-2">
                ...
                <input
                    ...
                    onChange={apartmentHandleChange}
                    className="text-white border-[0.5px] bg-transparent p-2 h-fit w-auto rounded"
                />
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
                <label className="font-semibold tracking-wider">HOUSEHOLD TOILETS WITH</label>
                <Select
            ...
            <div className="flex items-center gap-2">
                <label className="font-semibold tracking-wider">HOUSEHOLD SOURCE OF WATER</label>
                <Select
                    name="sourceofwater"
